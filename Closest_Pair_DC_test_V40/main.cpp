 ...
 * 
 * Version with unsigned int d_S_yy[] instead of boolean. 
 * Gives almost the same performance as bool version but with more memory utilization, fewer memory transactions, more arithmetics.
...
int main(int argc, char **argv){
	...
	h_S_yy	= (uint   *)malloc(	N		* sizeof(uint  ));
    ...
    error = cudaMalloc((void**) &d_S_yy,	 (N/base) * sizeof(uint  ));	checkCudaErrors(error);
